...
| Fix-69 | Inline delete confirmation (Cancel + Confirm delete replaces window.confirm); admin client for DELETE route ownership SELECT + soft-delete UPDATE | ProgrammesManagement.tsx + [programmeId]/route.ts | 🟢 Low | ✅ |
