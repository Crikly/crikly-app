      ...
      <div className="w-full max-w-3xl flex flex-col gap-6 pb-20">
        ...
        {loading ? (
          ...
          <>
            ...
            {fullyConnected ? (
              <div className="bg-white rounded-lg shadow-md p-6 flex items-center gap-4" data-testid="stripe-status-connected">
              ...
              <div className="bg-white rounded-lg shadow-md p-6 flex items-center gap-4" data-testid="stripe-status-disconnected">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex flex-col gap-5">
            ...
            {/* Tax section */}
            <div className="bg-white rounded-lg shadow-md px-6 py-2 flex flex-col">
