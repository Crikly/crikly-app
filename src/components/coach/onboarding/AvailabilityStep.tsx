        ...
        <div className="sticky top-6">
          ...
          {scheduleBlocks.length > 0 ? (
            <div className="bg-[#F0FDF4] border border-[#86EFAC] rounded-lg p-3">
              <p className="text-[11px] font-bold text-[#166534] mb-1">✓ Your availability is visible to parents</p>
              <p className="text-[10px] text-[#166534]">Parents can see your available days in search results</p>
            </div>
          ) : (
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
              <p className="text-[11px] font-medium text-gray-600">Add your first availability block so parents can book you</p>
            </div>
          )}
        </div>
      </aside>
